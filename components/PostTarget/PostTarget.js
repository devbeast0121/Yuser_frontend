...
import { MakePostUrl, AvatarUrl } from "../../stores/tools";
...
import PostsListGrid from '../PostsListGrid/PostsListGrid';
...
export default inject("store")(
  observer(function PostTarget(props) {
    //   H O O K S
    ...
    const commentsContainerHeightRef = React.createRef();
    const commentsMobileContainerHeightRef = React.createRef();
    const [commentsContainerHeight, setCommentsContainerHeight] = useState(0)
    ...
    */
    React.useEffect(() => {
      setCommentsContainerHeight(commentsContainerHeightRef.current.clientHeight)
      if (showCommentsModal) {
        setCommentsMobileContainerHeight(commentsMobileContainerHeightRef.current.clientHeight)
      }
    }, [usePost, showCommentsModal]);

    return (
      <MainContainer>
        <PostContainer>
          <Post>
            <div ref={commentsContainerHeightRef} style={{maxHeight:"100vh",maxWidth:"100%"}}>
              <PostMedia
                post={usePost}
                singleMode={true}
                size={'l'}
                  ...
                  <>
                    <CommentsContainer>
                      <CommentsListInfiniteScroll
                        ...
                        scrollingContainerHeight={commentsContainerHeight}
                        mobileSize={false}
                      />
                    </CommentsContainer>
                    {state.btnType !== BUTTON_TYPES.BUY && session && (
            ...
            <MainContainer>
              ...
              <div style={{ display: "flex", flex: 1 }} ref={commentsMobileContainerHeightRef} >
                <CommentsListInfiniteScroll
                  ...
                  targetPostId={props.targetPostId}
                  postComments={props.postComments}
                  scrollingContainerHeight={commentsMobileContainerHeight}
                  mobileSize={true}
                />
              </div>
