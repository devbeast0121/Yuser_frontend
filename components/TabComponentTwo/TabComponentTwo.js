...
export default function TabComponentTwo(props) {
...
const LeftTab = styled.div`
  ...
  background-color: ${(props) =>
    props.theme.name == "light" && props.leftActive
      ? COLORS.white
      : props.theme.name == "light" && !props.leftActive
      ? "none"
      : props.theme.name == "dark" && props.leftActive
      ? COLORS.black
      : "none"};
  cursor: pointer;
  border-top-right-radius: ${(props) => (props.leftActive ? 10 : 0)}px;
  border-bottom-right-radius: ${(props) => (props.leftActive ? 10 : 0)}px;
  box-shadow: 7px 0px 10px ${({ theme }) => theme.borderColor.color};
...
const RightTab = styled.div`
  ...
  align-items: center;
  background-color: ${(props) =>
    props.theme.name == "light" && props.rightActive
      ? COLORS.white
      : props.theme.name == "light" && !props.rightActive
      ? "none"
      : props.theme.name == "dark" && props.rightActive
      ? COLORS.black
      : "none"};
  cursor: pointer;
